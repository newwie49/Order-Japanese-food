                    ...
                    <form action="saveposition.php" method="post">
                     <div class="row">
                        ...
                        <div class="input-group mt-3">
                            ...
                            <input type="text" class="form-control" placeholder="" name="positionid" id="positionid" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="input-group mt-3">
                            ...
                            <input type="text" class="form-control" placeholder="" name="positionname" id="positionid" >
                            </div>
                        </div>
                    </div>
                    <div class="row">
